      ...
      <div className="w-full h-fit" style={{ background: "linear-gradient(117deg, rgb(206, 234, 241), rgb(237, 248, 247) 53%, rgb(148, 198, 196))" }}>
        ...
        <div className="grid lg:grid-cols-3 grid-rows-1 justify-items-center items-center mt-12 md:mt-20 lg:mt-28 xl:mt-0 sm:mt-0">
          <div className="lg:col-span-2 row-span-2 ">
            <h1 className="text-4xl ml-3 sm:ml-5 sm:text-7xl font-bold text-black drop-shadow-heading" data-aos="slide-right">Together We learn,</h1>
            <h1 className="mt-10 text-4xl ml-3  sm:ml-5  sm:text-7xl font-bold drop-shadow-heading" data-aos="slide-right" data-aos-duration="1300">Together We grow.</h1>
